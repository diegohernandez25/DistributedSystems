...
public class Parameters {
    ...
    public final static String GENERALREP_HOST      = "localhost";
    public final static String LOUNGE_HOST          = "localhost";
    public final static String PARK_HOST            = "localhost";
    public final static String OW_HOST              = "localhost";
    public final static String REPAIRAREA_HOST      = "localhost";
    public final static String SS_HOST              = "localhost";
    public final static String MECHANIC_HOST        = "localhost";
    public final static String MANAGER_HOST         = "localhost";
    public final static String CUSTOMER_HOST        = "localhost";
    public final static String REGISTRY_HOST        = "localhost";
